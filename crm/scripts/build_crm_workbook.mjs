  ...
  },
  {
    ...
    rows: [
      [
        ...
        "Instant prints and instant digital sharing included. 50% retainer is $225. No 360 booth.",
        "Yes",
      ],
      [
        "PKG-002",
        ...
        "=E3-F3",
        "DSLR booth; instant sharing; one premium backdrop; professional lighting; custom overlay; props; attendant",
        "Instant prints and instant digital sharing included. 50% retainer is $287.50. No 360 booth.",
        "Yes",
      ],
      [
        "PKG-003",
        ...
        "=E4-F4",
        "DSLR booth; instant sharing; one premium backdrop; professional lighting; custom overlay; props; attendant",
        "Instant prints and instant digital sharing included. 50% retainer is $350. No 360 booth.",
        "Yes",
      ],
      [
        "PKG-004",
      ...
      [
        ...
        "",
        "",
        "DSLR print photo booth package with instant prints plus premium DJ services",
  ...
  },
  {
    ...
    rows: [
      ...
      [
        ...
        "DSLR Print Photo Booth",
        "Every DSLR Print Photo Booth package includes instant prints and instant digital sharing. We do not currently offer 360 photo booth services.",
        "No",
        "Yes",
      ],
    ],
