...
function normalizeLead(lead = {}) {
  return {
    ...
    serviceRequested: stringify(lead.service_requested || lead.serviceRequested || "DSLR Print Photo Booth - 2 Hours ($450)"),
...
function buildDealDescription(lead) {
  return [
    ...
    `Service: ${lead.serviceRequested || "DSLR Print Photo Booth - 2 Hours ($450)"}`,
