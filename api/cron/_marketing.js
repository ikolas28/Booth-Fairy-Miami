  ...
  return [
    ...buildTikTokContentDrafts(stats, weekKey, today),
    {
      ...
      notes: [
        batch,
        "Draft caption:",
        `A luxury DSLR print photo booth experience for ${stats.topEventType} in ${stats.topCity}. Instant prints, flattering studio flash, polished booth styling, custom overlay, instant sharing, and a digital gallery your guests can enjoy right away.`,
        "",
    ...
    },
    {
      ...
      notes: [
        batch,
        "Draft post:",
        "Planning a Miami celebration? Booth Fairy Miami brings a refined DSLR print photo booth setup with instant prints, instant sharing, a premium backdrop, studio flash lighting, props, and an attendant. DJ services are also available as a premium add-on for a seamless entertainment experience.",
        "",
  ...
  return [
    {
      ...
      notes: [
        ...
        "Caption:",
        `Luxury DSLR print photo booth for ${eventType} in ${city}. Instant prints, instant digital sharing, premium setup, custom overlay, and a polished guest experience. Send your event date to check availability. @boothfairymiami`,
    ...
    },
    {
      ...
      notes: [
        ...
        "Caption:",
        "For Miami events, booking photo booth + DJ together can make the night feel more coordinated. Booth Fairy Miami offers a luxury DSLR print booth with instant prints and premium DJ add-ons for weddings, birthdays, corporate events, and private parties. @boothfairymiami",
    ...
    },
    {
      ...
      notes: [
        ...
        "Production notes: Keep it clear and simple. Mention that instant prints are included."
      ].join("\n")
    },
    {
